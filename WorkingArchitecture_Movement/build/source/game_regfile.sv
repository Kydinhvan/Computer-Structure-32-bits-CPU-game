...
module game_regfile #(
        ...
        output reg [31:0] check_right_bound_out,
        output reg [7:0] led,
    ...
    logic [31:0] D_check_right_bound_d, D_check_right_bound_q = 1'h0;
    ...
    always @* begin
        ...
        D_check_right_bound_d = D_check_right_bound_q;
        ...
        if (we) begin
            ...
            case (wa)
                ...
                4'hb: begin
                    D_check_right_bound_d = regfile_data;
                end
                4'hc: begin
        ...
        check_right_bound_out = D_check_right_bound_q;
        D_temp_reg_d = D_temp_reg_q;
    end
    ...
    always @(posedge (clk)) begin
        if ((rst) == 1'b1) begin
            ...
            D_check_right_bound_q <= D_check_right_bound_d;
