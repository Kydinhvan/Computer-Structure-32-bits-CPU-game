...
module game_data_path #(
        ...
        input wire clk,
        input wire rst,
        output reg [($clog2(COLUMN_DIMENSION))-1:0] player_pos_x_out,
        output reg [($clog2(COLUMN_DIMENSION))-1:0] player_pos_y_out,
    ...
    localparam _MP_COLUMN_DIMENSION_873283284 = 16'h10;
    localparam _MP_ROW_DIMENSION_873283284 = 16'h10;
    localparam _MP_PIXEL_COUNT_873283284 = 16'h100;
    localparam _MP_BUFFER_SIZE_873283284 = 11'h400;
    ...
    game_cu #(
        .COLUMN_DIMENSION(_MP_COLUMN_DIMENSION_873283284),
        .ROW_DIMENSION(_MP_ROW_DIMENSION_873283284),
        .PIXEL_COUNT(_MP_PIXEL_COUNT_873283284),
        .BUFFER_SIZE(_MP_BUFFER_SIZE_873283284)
    ) game_cu (
        .left_btn(left_btn),
        .right_btn(right_btn),
        .rst(rst),
    ...
    localparam _MP_COLUMN_DIMENSION_670814505 = 16'h10;
    localparam _MP_ROW_DIMENSION_670814505 = 16'h10;
    localparam _MP_PIXEL_COUNT_670814505 = 16'h100;
    localparam _MP_BUFFER_SIZE_670814505 = 11'h400;
    logic [31:0] M_game_regfile_regfile_data;
    logic [31:0] M_game_regfile_rd1;
    logic [31:0] M_game_regfile_rd2;
    logic [3:0] M_game_regfile_player_pos_x_out;
    logic [3:0] M_game_regfile_player_pos_y_out;
    ...
    logic [31:0] M_game_regfile_check_right_bound_out;
    ...
    game_regfile #(
        .COLUMN_DIMENSION(_MP_COLUMN_DIMENSION_670814505),
        .ROW_DIMENSION(_MP_ROW_DIMENSION_670814505),
        .PIXEL_COUNT(_MP_PIXEL_COUNT_670814505),
        .BUFFER_SIZE(_MP_BUFFER_SIZE_670814505)
    ) game_regfile (
        ...
        .check_right_bound_out(M_game_regfile_check_right_bound_out),
    ...
    localparam _MP_COLUMN_DIMENSION_815367697 = 16'h10;
    localparam _MP_ROW_DIMENSION_815367697 = 16'h10;
    localparam _MP_PIXEL_COUNT_815367697 = 16'h100;
    localparam _MP_BUFFER_SIZE_815367697 = 11'h400;
    ...
    ram_mode #(
        .COLUMN_DIMENSION(_MP_COLUMN_DIMENSION_815367697),
        .ROW_DIMENSION(_MP_ROW_DIMENSION_815367697),
        .PIXEL_COUNT(_MP_PIXEL_COUNT_815367697),
        .BUFFER_SIZE(_MP_BUFFER_SIZE_815367697)
    ) ram_mode (
        .left_btn(left_btn),
        .right_btn(right_btn),
        .player_pos_x_out(M_game_regfile_player_pos_x_out),
