...
module alu_manual_tester #(
    ...
    localparam logic [4:0][0:0] _MP_RISE_526265517 = {{1'h1, 1'h1, 1'h1, 1'h1, 1'h1}};
    localparam logic [4:0][0:0] _MP_FALL_526265517 = {{1'h0, 1'h0, 1'h0, 1'h0, 1'h0}};
    logic [4:0] M_io_button_edge_in;
    logic [4:0] M_io_button_edge_out;
    
    genvar idx_0_526265517;
    
    generate
        for (idx_0_526265517 = 0; idx_0_526265517 < 5; idx_0_526265517 = idx_0_526265517 + 1) begin: forLoop_idx_0_526265517
            edge_detector #(
                .RISE(_MP_RISE_526265517[idx_0_526265517]),
                .FALL(_MP_FALL_526265517[idx_0_526265517])
            ) io_button_edge (
                .clk(clk),
                .in(M_io_button_edge_in[idx_0_526265517]),
                .out(M_io_button_edge_out[idx_0_526265517])
            );
        end
    endgenerate
    
    
    localparam logic [4:0][9:0] _MP_CLK_FREQ_425695031 = {{10'h3e8, 10'h3e8, 10'h3e8, 10'h3e8, 10'h3e8}};
    localparam _MP_MIN_DELAY_425695031 = 5'h14;
    localparam _MP_NUM_SYNC_425695031 = 2'h2;
    logic [4:0] M_io_button_cond_in;
    logic [4:0] M_io_button_cond_out;
    
    genvar idx_0_425695031;
    
    generate
        for (idx_0_425695031 = 0; idx_0_425695031 < 5; idx_0_425695031 = idx_0_425695031 + 1) begin: forLoop_idx_0_425695031
            button_conditioner #(
                .CLK_FREQ(_MP_CLK_FREQ_425695031[idx_0_425695031]),
                .MIN_DELAY(_MP_MIN_DELAY_425695031),
                .NUM_SYNC(_MP_NUM_SYNC_425695031)
            ) io_button_cond (
                .clk(clk),
                .in(M_io_button_cond_in[idx_0_425695031]),
                .out(M_io_button_cond_out[idx_0_425695031])
            );
        end
    endgenerate
