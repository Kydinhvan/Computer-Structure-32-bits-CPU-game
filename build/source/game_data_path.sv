...
module game_data_path #(
    ...
    localparam _MP_SIZE_272302453 = 1'h1;
    localparam _MP_DIV_272302453 = BULLET_SLOW_CLK_DIV;
    localparam _MP_TOP_272302453 = 1'h0;
    localparam _MP_UP_272302453 = 1'h1;
    logic [0:0] M_bullet_slow_clk_value;
    
    counter #(
        .SIZE(_MP_SIZE_272302453),
        .DIV(_MP_DIV_272302453),
        .TOP(_MP_TOP_272302453),
        .UP(_MP_UP_272302453)
    ) bullet_slow_clk (
        .rst(rst),
        .clk(clk),
    ...
    localparam _MP_COLUMN_DIMENSION_1003564182 = 16'h10;
    localparam _MP_ROW_DIMENSION_1003564182 = 16'h10;
    localparam _MP_PIXEL_COUNT_1003564182 = 16'h100;
    localparam _MP_BUFFER_SIZE_1003564182 = 11'h400;
    ...
    game_cu #(
        .COLUMN_DIMENSION(_MP_COLUMN_DIMENSION_1003564182),
        .ROW_DIMENSION(_MP_ROW_DIMENSION_1003564182),
        .PIXEL_COUNT(_MP_PIXEL_COUNT_1003564182),
        .BUFFER_SIZE(_MP_BUFFER_SIZE_1003564182)
    ) game_cu (
        .left_btn(left_btn),
        .right_btn(right_btn),
    ...
    localparam _MP_COLUMN_DIMENSION_1041039461 = 16'h10;
    localparam _MP_ROW_DIMENSION_1041039461 = 16'h10;
    ...
    game_regfile #(
        .COLUMN_DIMENSION(_MP_COLUMN_DIMENSION_1041039461),
        .ROW_DIMENSION(_MP_ROW_DIMENSION_1041039461)
    ) game_regfile (
    ...
    localparam _MP_COLUMN_DIMENSION_597690339 = 16'h10;
    localparam _MP_ROW_DIMENSION_597690339 = 16'h10;
    logic [31:0] M_rom_enemy_A_romdata_out;
    logic [31:0] M_rom_enemy_B_romdata_out;
    logic [31:0] M_rom_enemy_C_romdata_out;
    
    enemy_rom #(
        .COLUMN_DIMENSION(_MP_COLUMN_DIMENSION_597690339),
        .ROW_DIMENSION(_MP_ROW_DIMENSION_597690339)
    ) rom (
        .enemy_stage_pointer_out(M_game_regfile_enemy_stage_pointer_out),
    ...
    localparam _MP_COLUMN_DIMENSION_578498999 = 16'h10;
    localparam _MP_ROW_DIMENSION_578498999 = 16'h10;
    localparam _MP_PIXEL_COUNT_578498999 = 16'h100;
    localparam _MP_BUFFER_SIZE_578498999 = 11'h400;
    ...
    ram_mode #(
        .COLUMN_DIMENSION(_MP_COLUMN_DIMENSION_578498999),
        .ROW_DIMENSION(_MP_ROW_DIMENSION_578498999),
        .PIXEL_COUNT(_MP_PIXEL_COUNT_578498999),
        .BUFFER_SIZE(_MP_BUFFER_SIZE_578498999)
    ) ram_mode (
        .enemy_A_active_out(M_game_regfile_enemy_A_active_out),
        .enemy_B_active_out(M_game_regfile_enemy_B_active_out),
        .enemy_C_active_out(M_game_regfile_enemy_C_active_out),
