...
module ram_mode #(
    ...
    localparam _MP_SIZE_1853743386 = $clog2(PIXEL_COUNT);
    localparam _MP_COLUMN_DIMENSION_1853743386 = COLUMN_DIMENSION;
    logic [(_MP_SIZE_1853743386)-1:0] M_index_reverser_input_address;
    logic [(_MP_SIZE_1853743386)-1:0] M_index_reverser_output_address;
    
    index_reverser #(
        .SIZE(_MP_SIZE_1853743386),
        .COLUMN_DIMENSION(_MP_COLUMN_DIMENSION_1853743386)
    ) index_reverser (
    ...
    localparam _MP_RISE_452453966 = 1'h1;
    localparam _MP_FALL_452453966 = 1'h0;
    logic M_bullet_slow_clk_edge_in;
    logic M_bullet_slow_clk_edge_out;
    
    edge_detector #(
        .RISE(_MP_RISE_452453966),
        .FALL(_MP_FALL_452453966)
    ...
    localparam _MP_RISE_244045922 = 1'h1;
    localparam _MP_FALL_244045922 = 1'h0;
    logic M_enemy_A_active_edge_in;
    logic M_enemy_A_active_edge_out;
    
    edge_detector #(
        .RISE(_MP_RISE_244045922),
        .FALL(_MP_FALL_244045922)
    ) enemy_A_active_edge (
        .clk(clk),
    ...
    localparam _MP_RISE_2011890264 = 1'h1;
    localparam _MP_FALL_2011890264 = 1'h0;
    logic M_enemy_B_active_edge_in;
    logic M_enemy_B_active_edge_out;
    
    edge_detector #(
        .RISE(_MP_RISE_2011890264),
        .FALL(_MP_FALL_2011890264)
    ) enemy_B_active_edge (
        .clk(clk),
    ...
    localparam _MP_RISE_530826524 = 1'h1;
    localparam _MP_FALL_530826524 = 1'h0;
    logic M_enemy_C_active_edge_in;
    logic M_enemy_C_active_edge_out;
    
    edge_detector #(
        .RISE(_MP_RISE_530826524),
        .FALL(_MP_FALL_530826524)
    ) enemy_C_active_edge (
        .clk(clk),
    ...
    localparam _MP_ROW_DIMENSION_700951020 = ROW_DIMENSION;
    localparam _MP_COLUMN_DIMENSION_700951020 = COLUMN_DIMENSION;
    localparam _MP_ENCODING_AMOUNT_700951020 = 3'h5;
    logic M_ram_update;
    logic M_ram_enemy_A_update;
    logic M_ram_enemy_B_update;
    logic M_ram_enemy_C_update;
    logic [($clog2(_MP_COLUMN_DIMENSION_700951020))-1:0] M_ram_player_x_pos;
    logic [($clog2(_MP_ROW_DIMENSION_700951020))-1:0] M_ram_player_y_pos;
    logic [2:0] M_ram_bullet_colour_out;
    logic [($clog2(_MP_COLUMN_DIMENSION_700951020))-1:0] M_ram_bullet_x;
    logic [($clog2(_MP_ROW_DIMENSION_700951020))-1:0] M_ram_bullet_y;
    logic M_ram_bullet_active;
    logic [($clog2((5'h10)'(_MP_ROW_DIMENSION_700951020 * _MP_COLUMN_DIMENSION_700951020)))-1:0] M_ram_address;
    logic [($clog2(_MP_COLUMN_DIMENSION_700951020))-1:0] M_ram_enemy_A_x;
    logic [($clog2(_MP_ROW_DIMENSION_700951020))-1:0] M_ram_enemy_A_y;
    logic [2:0] M_ram_enemy_A_color;
    logic M_ram_enemy_A_active_out;
    logic [($clog2(_MP_COLUMN_DIMENSION_700951020))-1:0] M_ram_enemy_B_x;
    logic [($clog2(_MP_ROW_DIMENSION_700951020))-1:0] M_ram_enemy_B_y;
    logic [2:0] M_ram_enemy_B_color;
    logic M_ram_enemy_B_active_out;
    logic [($clog2(_MP_COLUMN_DIMENSION_700951020))-1:0] M_ram_enemy_C_x;
    logic [($clog2(_MP_ROW_DIMENSION_700951020))-1:0] M_ram_enemy_C_y;
    logic [2:0] M_ram_enemy_C_color;
    logic M_ram_enemy_C_active_out;
    logic [2:0] M_ram_out_encoding;
    logic M_ram_ready;
    logic [($clog2((5'h10)'(_MP_ROW_DIMENSION_700951020 * _MP_COLUMN_DIMENSION_700951020)))-1:0] M_ram_debug_address_pointer;
    logic [2:0] M_ram_debug_data;
    
    data_ram #(
        .ROW_DIMENSION(_MP_ROW_DIMENSION_700951020),
        .COLUMN_DIMENSION(_MP_COLUMN_DIMENSION_700951020),
        .ENCODING_AMOUNT(_MP_ENCODING_AMOUNT_700951020)
    ) ram (
        .clk(clk),
        .rst(rst),
        .update(M_ram_update),
    ...
    localparam _MP_PIXEL_COUNT_1034321199 = PIXEL_COUNT;
    logic M_driver_update;
    logic [23:0] M_driver_color;
    logic M_driver_clear;
    logic [($clog2(_MP_PIXEL_COUNT_1034321199))-1:0] M_driver_pixel_address;
    logic M_driver_data;
    ...
    ws2812b_driver #(
        .PIXEL_COUNT(_MP_PIXEL_COUNT_1034321199)
    ) driver (
        .clk(clk),
        .rst(rst),
    ...
    always @* begin
        ...
        case (D_fsm_q)
            ...
            1'h1: begin
                ...
                if (M_enemy_A_active_edge_out) begin
                    M_ram_enemy_A_update = 1'h1;
                end
                if (M_enemy_B_active_edge_out) begin
                    M_ram_enemy_B_update = 1'h1;
                end
                if (M_enemy_C_active_edge_out) begin
                    M_ram_enemy_C_update = 1'h1;
                end
                D_fsm_d = 1'h1;
            end
        endcase
