...
module alu_manual_tester #(
    ...
    localparam logic [4:0][0:0] _MP_RISE_216062766 = {{1'h1, 1'h1, 1'h1, 1'h1, 1'h1}};
    localparam logic [4:0][0:0] _MP_FALL_216062766 = {{1'h0, 1'h0, 1'h0, 1'h0, 1'h0}};
    logic [4:0] M_io_button_edge_in;
    logic [4:0] M_io_button_edge_out;
    
    genvar idx_0_216062766;
    
    generate
        for (idx_0_216062766 = 0; idx_0_216062766 < 5; idx_0_216062766 = idx_0_216062766 + 1) begin: forLoop_idx_0_216062766
            edge_detector #(
                .RISE(_MP_RISE_216062766[idx_0_216062766]),
                .FALL(_MP_FALL_216062766[idx_0_216062766])
            ) io_button_edge (
                .clk(clk),
                .in(M_io_button_edge_in[idx_0_216062766]),
                .out(M_io_button_edge_out[idx_0_216062766])
            );
        end
    endgenerate
    
    
    localparam logic [4:0][9:0] _MP_CLK_FREQ_1654209421 = {{10'h3e8, 10'h3e8, 10'h3e8, 10'h3e8, 10'h3e8}};
    localparam _MP_MIN_DELAY_1654209421 = 5'h14;
    localparam _MP_NUM_SYNC_1654209421 = 2'h2;
    logic [4:0] M_io_button_cond_in;
    logic [4:0] M_io_button_cond_out;
    
    genvar idx_0_1654209421;
    
    generate
        for (idx_0_1654209421 = 0; idx_0_1654209421 < 5; idx_0_1654209421 = idx_0_1654209421 + 1) begin: forLoop_idx_0_1654209421
            button_conditioner #(
                .CLK_FREQ(_MP_CLK_FREQ_1654209421[idx_0_1654209421]),
                .MIN_DELAY(_MP_MIN_DELAY_1654209421),
                .NUM_SYNC(_MP_NUM_SYNC_1654209421)
            ) io_button_cond (
                .clk(clk),
                .in(M_io_button_cond_in[idx_0_1654209421]),
                .out(M_io_button_cond_out[idx_0_1654209421])
            );
        end
    endgenerate
    
    
    localparam _MP_DIGITS_621904279 = 3'h4;
    localparam _MP_DIV_621904279 = 5'h10;
    logic [3:0][3:0] M_seg_values;
    logic [6:0] M_seg_seg;
    logic [3:0] M_seg_sel;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_621904279),
        .DIV(_MP_DIV_621904279)
    ) seg (
        .clk(clk),
        .rst(rst),
        .values(M_seg_values),
    ...
    always @* begin
        ...
        M_alu_a = D_a_q;
        M_alu_b = D_b_q;
        M_alu_alufn_signal = io_dip[2'h2][3'h6:1'h0];
        led = 8'h0;
