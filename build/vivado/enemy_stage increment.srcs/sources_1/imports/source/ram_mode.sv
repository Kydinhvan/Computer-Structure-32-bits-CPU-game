...
module ram_mode #(
    ...
    localparam _MP_SIZE_364209929 = $clog2(PIXEL_COUNT);
    localparam _MP_COLUMN_DIMENSION_364209929 = COLUMN_DIMENSION;
    logic [(_MP_SIZE_364209929)-1:0] M_index_reverser_input_address;
    logic [(_MP_SIZE_364209929)-1:0] M_index_reverser_output_address;
    
    index_reverser #(
        .SIZE(_MP_SIZE_364209929),
        .COLUMN_DIMENSION(_MP_COLUMN_DIMENSION_364209929)
    ) index_reverser (
    ...
    localparam _MP_COLUMN_DIMENSION_533705744 = COLUMN_DIMENSION;
    localparam _MP_ROW_DIMENSION_533705744 = 16'h10;
    logic [($clog2(_MP_COLUMN_DIMENSION_533705744 * _MP_COLUMN_DIMENSION_533705744))-1:0] M_rom_address;
    logic [2:0] M_rom_data;
    
    game_end_rom #(
        .COLUMN_DIMENSION(_MP_COLUMN_DIMENSION_533705744),
        .ROW_DIMENSION(_MP_ROW_DIMENSION_533705744)
    ) rom (
    ...
    localparam _MP_RISE_552378403 = 1'h1;
    localparam _MP_FALL_552378403 = 1'h0;
    logic M_bullet_slow_clk_edge_in;
    logic M_bullet_slow_clk_edge_out;
    
    edge_detector #(
        .RISE(_MP_RISE_552378403),
        .FALL(_MP_FALL_552378403)
    ...
    localparam _MP_RISE_1599666689 = 1'h1;
    localparam _MP_FALL_1599666689 = 1'h0;
    logic M_fast_clk_edge_in;
    logic M_fast_clk_edge_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1599666689),
        .FALL(_MP_FALL_1599666689)
    ) fast_clk_edge (
        .clk(clk),
    ...
    localparam _MP_ROW_DIMENSION_1122111176 = ROW_DIMENSION;
    localparam _MP_COLUMN_DIMENSION_1122111176 = COLUMN_DIMENSION;
    localparam _MP_ENCODING_AMOUNT_1122111176 = 3'h5;
    logic M_ram_update;
    logic [($clog2(_MP_COLUMN_DIMENSION_1122111176))-1:0] M_ram_player_x_pos;
    logic [($clog2(_MP_ROW_DIMENSION_1122111176))-1:0] M_ram_player_y_pos;
    logic [2:0] M_ram_bullet_colour_out;
    logic [($clog2(_MP_COLUMN_DIMENSION_1122111176))-1:0] M_ram_bullet_x;
    logic [($clog2(_MP_ROW_DIMENSION_1122111176))-1:0] M_ram_bullet_y;
    logic M_ram_bullet_active;
    logic [($clog2((5'h10)'(_MP_ROW_DIMENSION_1122111176 * _MP_COLUMN_DIMENSION_1122111176)))-1:0] M_ram_address;
    logic [($clog2(_MP_COLUMN_DIMENSION_1122111176))-1:0] M_ram_enemy_A_x;
    logic [($clog2(_MP_ROW_DIMENSION_1122111176))-1:0] M_ram_enemy_A_y;
    logic [2:0] M_ram_enemy_A_color;
    logic [($clog2(_MP_COLUMN_DIMENSION_1122111176))-1:0] M_ram_enemy_B_x;
    logic [($clog2(_MP_ROW_DIMENSION_1122111176))-1:0] M_ram_enemy_B_y;
    logic [2:0] M_ram_enemy_B_color;
    logic [($clog2(_MP_COLUMN_DIMENSION_1122111176))-1:0] M_ram_enemy_C_x;
    logic [($clog2(_MP_ROW_DIMENSION_1122111176))-1:0] M_ram_enemy_C_y;
    logic [2:0] M_ram_enemy_C_color;
    logic [2:0] M_ram_out_encoding;
    logic M_ram_ready;
    logic [($clog2((5'h10)'(_MP_ROW_DIMENSION_1122111176 * _MP_COLUMN_DIMENSION_1122111176)))-1:0] M_ram_debug_address_pointer;
    logic [2:0] M_ram_debug_data;
    
    data_ram #(
        .ROW_DIMENSION(_MP_ROW_DIMENSION_1122111176),
        .COLUMN_DIMENSION(_MP_COLUMN_DIMENSION_1122111176),
        .ENCODING_AMOUNT(_MP_ENCODING_AMOUNT_1122111176)
    ) ram (
        .clk(clk),
        .rst(rst),
        .update(M_ram_update),
    ...
    localparam _MP_PIXEL_COUNT_1012969844 = PIXEL_COUNT;
    logic M_driver_update;
    logic [23:0] M_driver_color;
    logic M_driver_clear;
    logic [($clog2(_MP_PIXEL_COUNT_1012969844))-1:0] M_driver_pixel_address;
    logic M_driver_data;
    ...
    ws2812b_driver #(
        .PIXEL_COUNT(_MP_PIXEL_COUNT_1012969844)
    ) driver (
        .clk(clk),
        .rst(rst),
    ...
    always @* begin
        ...
        if (~game_end_flag_out) begin
            ...
            M_rom_address = M_index_reverser_output_address;
            M_driver_color = LEDCOLOR[M_rom_data];
        end
