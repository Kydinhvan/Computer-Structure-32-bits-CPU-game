...
module alchitry_top (
    ...
    localparam _MP_RISE_1635663528 = 1'h1;
    localparam _MP_FALL_1635663528 = 1'h0;
    logic M_edge_dt_btn_left_in;
    logic M_edge_dt_btn_left_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1635663528),
        .FALL(_MP_FALL_1635663528)
    ) edge_dt_btn_left (
        .clk(clk),
    ...
    localparam _MP_RISE_1279693659 = 1'h1;
    localparam _MP_FALL_1279693659 = 1'h0;
    logic M_edge_dt_btn_right_in;
    logic M_edge_dt_btn_right_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1279693659),
        .FALL(_MP_FALL_1279693659)
    ) edge_dt_btn_right (
        .clk(clk),
    ...
    localparam _MP_RISE_1367307588 = 1'h1;
    localparam _MP_FALL_1367307588 = 1'h0;
    logic M_edge_dt_btn_redshoot_in;
    logic M_edge_dt_btn_redshoot_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1367307588),
        .FALL(_MP_FALL_1367307588)
    ...
    localparam _MP_RISE_630518206 = 1'h1;
    localparam _MP_FALL_630518206 = 1'h0;
    logic M_edge_dt_btn_greenshoot_in;
    logic M_edge_dt_btn_greenshoot_out;
    
    edge_detector #(
        .RISE(_MP_RISE_630518206),
        .FALL(_MP_FALL_630518206)
    ...
    localparam _MP_RISE_416397436 = 1'h1;
    localparam _MP_FALL_416397436 = 1'h0;
    logic M_edge_dt_btn_start_btn_in;
    logic M_edge_dt_btn_start_btn_out;
    
    edge_detector #(
        .RISE(_MP_RISE_416397436),
        .FALL(_MP_FALL_416397436)
    ...
    localparam _MP_CLK_FREQ_1287675058 = 24'h989680;
    localparam _MP_MIN_DELAY_1287675058 = 5'h14;
    localparam _MP_NUM_SYNC_1287675058 = 2'h2;
    logic M_btn_cond_left_in;
    logic M_btn_cond_left_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_1287675058),
        .MIN_DELAY(_MP_MIN_DELAY_1287675058),
        .NUM_SYNC(_MP_NUM_SYNC_1287675058)
    ) btn_cond_left (
        .clk(clk),
    ...
    localparam _MP_CLK_FREQ_1226224157 = 24'h989680;
    localparam _MP_MIN_DELAY_1226224157 = 5'h14;
    localparam _MP_NUM_SYNC_1226224157 = 2'h2;
    logic M_btn_cond_right_in;
    logic M_btn_cond_right_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_1226224157),
        .MIN_DELAY(_MP_MIN_DELAY_1226224157),
        .NUM_SYNC(_MP_NUM_SYNC_1226224157)
    ) btn_cond_right (
        .clk(clk),
    ...
    localparam _MP_CLK_FREQ_2146350739 = 24'h989680;
    localparam _MP_MIN_DELAY_2146350739 = 5'h14;
    localparam _MP_NUM_SYNC_2146350739 = 2'h2;
    logic M_btn_cond_redshoot_in;
    logic M_btn_cond_redshoot_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_2146350739),
        .MIN_DELAY(_MP_MIN_DELAY_2146350739),
        .NUM_SYNC(_MP_NUM_SYNC_2146350739)
    ) btn_cond_redshoot (
        .clk(clk),
    ...
    localparam _MP_CLK_FREQ_19232475 = 24'h989680;
    localparam _MP_MIN_DELAY_19232475 = 5'h14;
    localparam _MP_NUM_SYNC_19232475 = 2'h2;
    logic M_btn_cond_greenshoot_in;
    logic M_btn_cond_greenshoot_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_19232475),
        .MIN_DELAY(_MP_MIN_DELAY_19232475),
        .NUM_SYNC(_MP_NUM_SYNC_19232475)
    ) btn_cond_greenshoot (
        .clk(clk),
    ...
    localparam _MP_CLK_FREQ_1857669717 = 24'h989680;
    localparam _MP_MIN_DELAY_1857669717 = 5'h14;
    localparam _MP_NUM_SYNC_1857669717 = 2'h2;
    logic M_btn_cond_start_btn_in;
    logic M_btn_cond_start_btn_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_1857669717),
        .MIN_DELAY(_MP_MIN_DELAY_1857669717),
        .NUM_SYNC(_MP_NUM_SYNC_1857669717)
    ) btn_cond_start_btn (
        .clk(clk),
    ...
    localparam _MP_STAGES_306383813 = 3'h4;
    logic M_reset_cond_in;
    logic M_reset_cond_out;
    
    reset_conditioner #(
        .STAGES(_MP_STAGES_306383813)
    ) reset_cond (
        .clk(clk),
        .in(M_reset_cond_in),
    ...
    localparam _MP_COLUMN_DIMENSION_462382156 = 16'h10;
    localparam _MP_ROW_DIMENSION_462382156 = 16'h10;
    localparam _MP_PIXEL_COUNT_462382156 = 16'h100;
    localparam _MP_BUFFER_SIZE_462382156 = 11'h400;
    localparam _MP_BULLET_SLOW_CLK_DIV_462382156 = 5'h16;
    localparam _MP_FAST_CLOCK_DIV_462382156 = 5'h15;
    localparam _MP_ENEMY_A_SLOW_CLK_DIV_462382156 = 5'h15;
    localparam _MP_TIMER_SLOW_CLK_DIV_462382156 = 5'h1a;
    ...
    game_data_path #(
        .COLUMN_DIMENSION(_MP_COLUMN_DIMENSION_462382156),
        .ROW_DIMENSION(_MP_ROW_DIMENSION_462382156),
        .PIXEL_COUNT(_MP_PIXEL_COUNT_462382156),
        .BUFFER_SIZE(_MP_BUFFER_SIZE_462382156),
        .BULLET_SLOW_CLK_DIV(_MP_BULLET_SLOW_CLK_DIV_462382156),
        .FAST_CLOCK_DIV(_MP_FAST_CLOCK_DIV_462382156),
        .ENEMY_A_SLOW_CLK_DIV(_MP_ENEMY_A_SLOW_CLK_DIV_462382156),
        .TIMER_SLOW_CLK_DIV(_MP_TIMER_SLOW_CLK_DIV_462382156)
    ) game_data_path (
        .clk(clk),
        .rst(rst),
