...
module game_regfile #(
    ...
    logic [($clog2(COLUMN_DIMENSION))-1:0] D_enemy_A_x_d, D_enemy_A_x_q = 1'h0;
    logic [($clog2(ROW_DIMENSION))-1:0] D_enemy_A_y_d, D_enemy_A_y_q = 1'h0;
    logic [31:0] D_enemy_A_color_d, D_enemy_A_color_q = 1'h0;
    logic [($clog2(COLUMN_DIMENSION))-1:0] D_enemy_B_x_d, D_enemy_B_x_q = 1'h0;
    logic [($clog2(ROW_DIMENSION))-1:0] D_enemy_B_y_d, D_enemy_B_y_q = 1'h0;
    logic [31:0] D_enemy_B_color_d, D_enemy_B_color_q = 1'h0;
    logic [($clog2(COLUMN_DIMENSION))-1:0] D_enemy_C_x_d, D_enemy_C_x_q = 1'h0;
    logic [($clog2(ROW_DIMENSION))-1:0] D_enemy_C_y_d, D_enemy_C_y_q = 1'h0;
    logic [31:0] D_enemy_C_color_d, D_enemy_C_color_q = 1'h0;
    always @* begin
        ...
        D_enemy_A_x_d = D_enemy_A_x_q;
        D_enemy_A_y_d = D_enemy_A_y_q;
        D_enemy_A_color_d = D_enemy_A_color_q;
        D_enemy_B_x_d = D_enemy_B_x_q;
        D_enemy_B_y_d = D_enemy_B_y_q;
        D_enemy_B_color_d = D_enemy_B_color_q;
        D_enemy_C_x_d = D_enemy_C_x_q;
        D_enemy_C_y_d = D_enemy_C_y_q;
        D_enemy_C_color_d = D_enemy_C_color_q;
        ...
        if (we) begin
            ...
            case (wa)
                ...
                5'h10: begin
                    D_enemy_A_x_d = regfile_data;
                end
                5'h11: begin
                    D_enemy_A_y_d = regfile_data;
                end
                5'h12: begin
                    D_enemy_A_color_d = regfile_data;
                end
                5'h13: begin
                    D_enemy_B_x_d = regfile_data;
                end
                5'h14: begin
                    D_enemy_B_y_d = regfile_data;
                end
                5'h15: begin
                    D_enemy_B_color_d = regfile_data;
                end
                5'h16: begin
                    D_enemy_C_x_d = regfile_data;
                end
                5'h17: begin
                    D_enemy_C_y_d = regfile_data;
                end
                5'h18: begin
                    D_enemy_C_color_d = regfile_data;
                end
            endcase
        end
        ...
        enemy_A_x_out = D_enemy_A_x_q;
        enemy_A_y_out = D_enemy_A_y_q;
        enemy_A_color_out = D_enemy_A_color_q;
        enemy_A_active_out = D_enemy_A_active_q;
        enemy_B_x_out = D_enemy_B_x_q;
        enemy_B_y_out = D_enemy_B_y_q;
        enemy_B_color_out = D_enemy_B_color_q;
        enemy_B_active_out = D_enemy_B_active_q;
        enemy_C_x_out = D_enemy_C_x_q;
        enemy_C_y_out = D_enemy_C_y_q;
    ...
    always @(posedge (clk)) begin
        if ((rst) == 1'b1) begin
            ...
            D_enemy_A_x_q <= 1'h0;
            D_enemy_A_y_q <= 1'h0;
            D_enemy_A_color_q <= 1'h0;
            D_enemy_B_x_q <= 1'h0;
            D_enemy_B_y_q <= 1'h0;
            D_enemy_B_color_q <= 1'h0;
            D_enemy_C_x_q <= 1'h0;
            D_enemy_C_y_q <= 1'h0;
            D_enemy_C_color_q <= 1'h0;
        end else begin
            ...
            D_enemy_A_x_q <= D_enemy_A_x_d;
            D_enemy_A_y_q <= D_enemy_A_y_d;
            D_enemy_A_color_q <= D_enemy_A_color_d;
            D_enemy_B_x_q <= D_enemy_B_x_d;
            D_enemy_B_y_q <= D_enemy_B_y_d;
            D_enemy_B_color_q <= D_enemy_B_color_d;
            D_enemy_C_x_q <= D_enemy_C_x_d;
            D_enemy_C_y_q <= D_enemy_C_y_d;
            D_enemy_C_color_q <= D_enemy_C_color_d;
        end
    end
endmodule