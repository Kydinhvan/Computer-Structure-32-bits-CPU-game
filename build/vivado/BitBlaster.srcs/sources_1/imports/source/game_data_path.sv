...
module game_data_path #(
    ...
    localparam _MP_SIZE_190579185 = 1'h1;
    localparam _MP_DIV_190579185 = BULLET_SLOW_CLK_DIV;
    localparam _MP_TOP_190579185 = 1'h0;
    localparam _MP_UP_190579185 = 1'h1;
    logic [0:0] M_bullet_slow_clk_value;
    
    counter #(
        .SIZE(_MP_SIZE_190579185),
        .DIV(_MP_DIV_190579185),
        .TOP(_MP_TOP_190579185),
        .UP(_MP_UP_190579185)
    ) bullet_slow_clk (
        .rst(rst),
        .clk(clk),
    ...
    localparam _MP_COLUMN_DIMENSION_532089194 = 16'h10;
    localparam _MP_ROW_DIMENSION_532089194 = 16'h10;
    localparam _MP_PIXEL_COUNT_532089194 = 16'h100;
    localparam _MP_BUFFER_SIZE_532089194 = 11'h400;
    ...
    game_cu #(
        .COLUMN_DIMENSION(_MP_COLUMN_DIMENSION_532089194),
        .ROW_DIMENSION(_MP_ROW_DIMENSION_532089194),
        .PIXEL_COUNT(_MP_PIXEL_COUNT_532089194),
        .BUFFER_SIZE(_MP_BUFFER_SIZE_532089194)
    ) game_cu (
        .left_btn(left_btn),
        .right_btn(right_btn),
        .shoot_btn(shoot_btn),
    ...
    localparam _MP_COLUMN_DIMENSION_1433142920 = 16'h10;
    localparam _MP_ROW_DIMENSION_1433142920 = 16'h10;
    localparam _MP_PIXEL_COUNT_1433142920 = 16'h100;
    localparam _MP_BUFFER_SIZE_1433142920 = 11'h400;
    ...
    game_regfile #(
        .COLUMN_DIMENSION(_MP_COLUMN_DIMENSION_1433142920),
        .ROW_DIMENSION(_MP_ROW_DIMENSION_1433142920),
        .PIXEL_COUNT(_MP_PIXEL_COUNT_1433142920),
        .BUFFER_SIZE(_MP_BUFFER_SIZE_1433142920)
    ) game_regfile (
    ...
    localparam _MP_COLUMN_DIMENSION_245199879 = 16'h10;
    localparam _MP_ROW_DIMENSION_245199879 = 16'h10;
    localparam _MP_PIXEL_COUNT_245199879 = 16'h100;
    localparam _MP_BUFFER_SIZE_245199879 = 11'h400;
    ...
    ram_mode #(
        .COLUMN_DIMENSION(_MP_COLUMN_DIMENSION_245199879),
        .ROW_DIMENSION(_MP_ROW_DIMENSION_245199879),
        .PIXEL_COUNT(_MP_PIXEL_COUNT_245199879),
        .BUFFER_SIZE(_MP_BUFFER_SIZE_245199879)
    ) ram_mode (
        .left_btn(left_btn),
        .right_btn(right_btn),
        .shoot_btn(shoot_btn),
