...
module ram_mode #(
    ...
    localparam _MP_SIZE_1845718250 = $clog2(PIXEL_COUNT);
    localparam _MP_COLUMN_DIMENSION_1845718250 = COLUMN_DIMENSION;
    logic [(_MP_SIZE_1845718250)-1:0] M_index_reverser_input_address;
    logic [(_MP_SIZE_1845718250)-1:0] M_index_reverser_output_address;
    
    index_reverser #(
        .SIZE(_MP_SIZE_1845718250),
        .COLUMN_DIMENSION(_MP_COLUMN_DIMENSION_1845718250)
    ) index_reverser (
    ...
    localparam _MP_RISE_1852612730 = 1'h1;
    localparam _MP_FALL_1852612730 = 1'h0;
    logic M_bullet_slow_clk_edge_in;
    logic M_bullet_slow_clk_edge_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1852612730),
        .FALL(_MP_FALL_1852612730)
    ...
    localparam _MP_RISE_1436027516 = 1'h1;
    localparam _MP_FALL_1436027516 = 1'h0;
    logic M_fast_clk_edge_in;
    logic M_fast_clk_edge_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1436027516),
        .FALL(_MP_FALL_1436027516)
    ) fast_clk_edge (
        .clk(clk),
    ...
    localparam _MP_RISE_1299040703 = 1'h1;
    localparam _MP_FALL_1299040703 = 1'h0;
    logic M_enemy_A_active_edge_in;
    logic M_enemy_A_active_edge_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1299040703),
        .FALL(_MP_FALL_1299040703)
    ) enemy_A_active_edge (
        .clk(clk),
    ...
    localparam _MP_RISE_1938432965 = 1'h1;
    localparam _MP_FALL_1938432965 = 1'h0;
    logic M_enemy_B_active_edge_in;
    logic M_enemy_B_active_edge_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1938432965),
        .FALL(_MP_FALL_1938432965)
    ) enemy_B_active_edge (
        .clk(clk),
    ...
    localparam _MP_RISE_1173574591 = 1'h1;
    localparam _MP_FALL_1173574591 = 1'h0;
    logic M_enemy_C_active_edge_in;
    logic M_enemy_C_active_edge_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1173574591),
        .FALL(_MP_FALL_1173574591)
    ) enemy_C_active_edge (
        .clk(clk),
    ...
    localparam _MP_RISE_1704523535 = 1'h0;
    localparam _MP_FALL_1704523535 = 1'h1;
    logic M_enemy_A_inactive_edge_in;
    logic M_enemy_A_inactive_edge_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1704523535),
        .FALL(_MP_FALL_1704523535)
    ...
    localparam _MP_RISE_869140873 = 1'h0;
    localparam _MP_FALL_869140873 = 1'h1;
    logic M_enemy_B_inactive_edge_in;
    logic M_enemy_B_inactive_edge_out;
    
    edge_detector #(
        .RISE(_MP_RISE_869140873),
        .FALL(_MP_FALL_869140873)
    ...
    localparam _MP_RISE_2043469329 = 1'h0;
    localparam _MP_FALL_2043469329 = 1'h1;
    logic M_enemy_C_inactive_edge_in;
    logic M_enemy_C_inactive_edge_out;
    
    edge_detector #(
        .RISE(_MP_RISE_2043469329),
        .FALL(_MP_FALL_2043469329)
    ...
    localparam _MP_ROW_DIMENSION_1620981293 = ROW_DIMENSION;
    localparam _MP_COLUMN_DIMENSION_1620981293 = COLUMN_DIMENSION;
    localparam _MP_ENCODING_AMOUNT_1620981293 = 3'h5;
    logic M_ram_update;
    logic M_ram_enemy_A_update;
    logic M_ram_enemy_B_update;
    logic M_ram_enemy_C_update;
    logic [($clog2(_MP_COLUMN_DIMENSION_1620981293))-1:0] M_ram_player_x_pos;
    logic [($clog2(_MP_ROW_DIMENSION_1620981293))-1:0] M_ram_player_y_pos;
    logic [2:0] M_ram_bullet_colour_out;
    logic [($clog2(_MP_COLUMN_DIMENSION_1620981293))-1:0] M_ram_bullet_x;
    logic [($clog2(_MP_ROW_DIMENSION_1620981293))-1:0] M_ram_bullet_y;
    logic M_ram_bullet_active;
    logic [($clog2((5'h10)'(_MP_ROW_DIMENSION_1620981293 * _MP_COLUMN_DIMENSION_1620981293)))-1:0] M_ram_address;
    logic [($clog2(_MP_COLUMN_DIMENSION_1620981293))-1:0] M_ram_enemy_A_x;
    logic [($clog2(_MP_ROW_DIMENSION_1620981293))-1:0] M_ram_enemy_A_y;
    logic [2:0] M_ram_enemy_A_color;
    logic M_ram_enemy_A_active_out;
    logic [($clog2(_MP_COLUMN_DIMENSION_1620981293))-1:0] M_ram_enemy_B_x;
    logic [($clog2(_MP_ROW_DIMENSION_1620981293))-1:0] M_ram_enemy_B_y;
    logic [2:0] M_ram_enemy_B_color;
    logic M_ram_enemy_B_active_out;
    logic [($clog2(_MP_COLUMN_DIMENSION_1620981293))-1:0] M_ram_enemy_C_x;
    logic [($clog2(_MP_ROW_DIMENSION_1620981293))-1:0] M_ram_enemy_C_y;
    logic [2:0] M_ram_enemy_C_color;
    logic M_ram_enemy_C_active_out;
    logic [2:0] M_ram_out_encoding;
    logic M_ram_ready;
    logic [($clog2((5'h10)'(_MP_ROW_DIMENSION_1620981293 * _MP_COLUMN_DIMENSION_1620981293)))-1:0] M_ram_debug_address_pointer;
    logic [2:0] M_ram_debug_data;
    
    data_ram #(
        .ROW_DIMENSION(_MP_ROW_DIMENSION_1620981293),
        .COLUMN_DIMENSION(_MP_COLUMN_DIMENSION_1620981293),
        .ENCODING_AMOUNT(_MP_ENCODING_AMOUNT_1620981293)
    ) ram (
        .clk(clk),
        .rst(rst),
        .update(M_ram_update),
    ...
    localparam _MP_PIXEL_COUNT_1112568143 = PIXEL_COUNT;
    logic M_driver_update;
    logic [23:0] M_driver_color;
    logic M_driver_clear;
    logic [($clog2(_MP_PIXEL_COUNT_1112568143))-1:0] M_driver_pixel_address;
    logic M_driver_data;
    ...
    ws2812b_driver #(
        .PIXEL_COUNT(_MP_PIXEL_COUNT_1112568143)
    ) driver (
        .clk(clk),
        .rst(rst),
