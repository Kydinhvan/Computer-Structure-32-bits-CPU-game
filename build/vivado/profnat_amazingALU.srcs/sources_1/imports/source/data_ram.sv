...
module data_ram #(
    ...
    localparam _MP_WIDTH_674842797 = $clog2(ENCODING_AMOUNT);
    localparam _MP_ENTRIES_674842797 = DEPTH;
    logic [((($clog2(_MP_ENTRIES_674842797)-1) - (0) + 1))-1:0] M_ram_waddr;
    logic [(((_MP_WIDTH_674842797-1) - (0) + 1))-1:0] M_ram_write_data;
    logic M_ram_write_enable;
    logic [((($clog2(_MP_ENTRIES_674842797)-1) - (0) + 1))-1:0] M_ram_raddr;
    logic [(((_MP_WIDTH_674842797-1) - (0) + 1))-1:0] M_ram_read_data;
    
    simple_dual_port_ram #(
        .WIDTH(_MP_WIDTH_674842797),
        .ENTRIES(_MP_ENTRIES_674842797)
    ) ram (
        .rclk(clk),
        .wclk(clk),
        .waddr(M_ram_waddr),
