...
module game_data_path #(
    ...
    localparam _MP_SIZE_6778602 = 1'h1;
    localparam _MP_DIV_6778602 = BULLET_SLOW_CLK_DIV;
    localparam _MP_TOP_6778602 = 1'h0;
    localparam _MP_UP_6778602 = 1'h1;
    logic [0:0] M_bullet_slow_clk_value;
    
    counter #(
        .SIZE(_MP_SIZE_6778602),
        .DIV(_MP_DIV_6778602),
        .TOP(_MP_TOP_6778602),
        .UP(_MP_UP_6778602)
    ) bullet_slow_clk (
    ...
    localparam _MP_SIZE_438411795 = 1'h1;
    localparam _MP_DIV_438411795 = FAST_CLOCK_DIV;
    localparam _MP_TOP_438411795 = 1'h0;
    localparam _MP_UP_438411795 = 1'h1;
    logic [0:0] M_fast_clk_value;
    
    counter #(
        .SIZE(_MP_SIZE_438411795),
        .DIV(_MP_DIV_438411795),
        .TOP(_MP_TOP_438411795),
        .UP(_MP_UP_438411795)
    ) fast_clk (
        .rst(rst),
        .clk(clk),
    ...
    localparam _MP_COLUMN_DIMENSION_1192968077 = 16'h10;
    localparam _MP_ROW_DIMENSION_1192968077 = 16'h10;
    localparam _MP_PIXEL_COUNT_1192968077 = 16'h100;
    localparam _MP_BUFFER_SIZE_1192968077 = 11'h400;
    ...
    game_cu #(
        .COLUMN_DIMENSION(_MP_COLUMN_DIMENSION_1192968077),
        .ROW_DIMENSION(_MP_ROW_DIMENSION_1192968077),
        .PIXEL_COUNT(_MP_PIXEL_COUNT_1192968077),
        .BUFFER_SIZE(_MP_BUFFER_SIZE_1192968077)
    ) game_cu (
        .left_btn(left_btn),
        .right_btn(right_btn),
    ...
    localparam _MP_COLUMN_DIMENSION_277814869 = 16'h10;
    localparam _MP_ROW_DIMENSION_277814869 = 16'h10;
    ...
    game_regfile #(
        .COLUMN_DIMENSION(_MP_COLUMN_DIMENSION_277814869),
        .ROW_DIMENSION(_MP_ROW_DIMENSION_277814869)
    ) game_regfile (
    ...
    localparam _MP_COLUMN_DIMENSION_500216021 = 16'h10;
    localparam _MP_ROW_DIMENSION_500216021 = 16'h10;
    logic [31:0] M_rom_enemy_A_romdata_out;
    logic [31:0] M_rom_enemy_B_romdata_out;
    logic [31:0] M_rom_enemy_C_romdata_out;
    
    enemy_rom #(
        .COLUMN_DIMENSION(_MP_COLUMN_DIMENSION_500216021),
        .ROW_DIMENSION(_MP_ROW_DIMENSION_500216021)
    ) rom (
        .enemy_stage_pointer_out(M_game_regfile_enemy_stage_pointer_out),
    ...
    localparam _MP_COLUMN_DIMENSION_722976961 = 16'h10;
    localparam _MP_ROW_DIMENSION_722976961 = 16'h10;
    localparam _MP_PIXEL_COUNT_722976961 = 16'h100;
    localparam _MP_BUFFER_SIZE_722976961 = 11'h400;
    ...
    ram_mode #(
        .COLUMN_DIMENSION(_MP_COLUMN_DIMENSION_722976961),
        .ROW_DIMENSION(_MP_ROW_DIMENSION_722976961),
        .PIXEL_COUNT(_MP_PIXEL_COUNT_722976961),
        .BUFFER_SIZE(_MP_BUFFER_SIZE_722976961)
    ) ram_mode (
        .enemy_A_active_out(M_game_regfile_enemy_A_active_out),
        .enemy_B_active_out(M_game_regfile_enemy_B_active_out),
        .enemy_C_active_out(M_game_regfile_enemy_C_active_out),
