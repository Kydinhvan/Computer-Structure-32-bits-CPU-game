...
module data_ram #(
    ...
    logic [1:0] D_stored_bullet_color_d, D_stored_bullet_color_q = 1'h0;
    localparam BACKGROUND_COLOR = 2'h0;
    localparam PLAYER_COLOR = 2'h1;
    localparam _MP_WIDTH_902822709 = $clog2(ENCODING_AMOUNT);
    localparam _MP_ENTRIES_902822709 = DEPTH;
    logic [((($clog2(_MP_ENTRIES_902822709)-1) - (0) + 1))-1:0] M_ram_waddr;
    logic [(((_MP_WIDTH_902822709-1) - (0) + 1))-1:0] M_ram_write_data;
    logic M_ram_write_enable;
    logic [((($clog2(_MP_ENTRIES_902822709)-1) - (0) + 1))-1:0] M_ram_raddr;
    logic [(((_MP_WIDTH_902822709-1) - (0) + 1))-1:0] M_ram_read_data;
    
    simple_dual_port_ram #(
        .WIDTH(_MP_WIDTH_902822709),
        .ENTRIES(_MP_ENTRIES_902822709)
    ) ram (
        .rclk(clk),
        .wclk(clk),
        .waddr(M_ram_waddr),
    ...
    always @* begin
        ...
        D_stored_bullet_color_d = D_stored_bullet_color_q;
        ...
        out_encoding = 1'h0;
        debug_data = 1'h0;
        bullet_color_out = D_stored_bullet_color_q;
        is_bullet = 1'h0;
        debug_data = 1'h0;
        D_player_writer_pointer_d = D_player_writer_pointer_q;
        D_bullet_writer_pointer_d = D_bullet_writer_pointer_q;
        ...
        case (D_fsm_q)
            ...
            4'h9: begin
                M_ram_write_enable = 1'h1;
                M_ram_waddr = D_bullet_writer_pointer_q;
                M_ram_write_data = D_stored_bullet_color_q;
                D_bullet_written_d = 1'h1;
                D_bullet_last_addr_d = D_bullet_writer_pointer_q;
                D_stored_bullet_color_d = bullet_color;
                D_fsm_d = 4'hb;
            end
            4'hb: begin
                M_ram_raddr = address;
                ...
                debug_data = 1'h0;
                if (D_bullet_written_q && address == D_bullet_last_addr_q) begin
                    is_bullet = 1'h1;
                end
                debug_data = 1'h0;
                D_fsm_d = 4'hb;
    ...
    always @(posedge (clk)) begin
        if ((rst) == 1'b1) begin
            ...
            D_stored_bullet_color_q <= D_stored_bullet_color_d;
        end
    end
endmodule