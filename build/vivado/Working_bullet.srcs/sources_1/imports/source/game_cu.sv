...
module game_cu #(
    ...
    localparam E_GameStates_SET_RED_BULLET_COLOR = 4'h8;
    localparam E_GameStates_SET_GREEN_BULLET_COLOR = 4'h9;
    localparam E_GameStates_SET_BLUE_BULLET_COLOR = 4'ha;
    localparam E_GameStates_CHECK_BULLET_BOUNDARY = 4'hb;
    localparam E_GameStates_BULLET_MOVE = 4'hc;
    localparam E_GameStates_BULLET_INACTIVE = 4'hd;
    localparam _MP_RISE_1295039460 = 1'h1;
    localparam _MP_FALL_1295039460 = 1'h0;
    logic M_bullet_slow_clk_edge_in;
    logic M_bullet_slow_clk_edge_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1295039460),
        .FALL(_MP_FALL_1295039460)
