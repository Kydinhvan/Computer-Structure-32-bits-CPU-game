...
module alchitry_top (
    ...
    localparam _MP_RISE_1840707699 = 1'h1;
    localparam _MP_FALL_1840707699 = 1'h0;
    logic M_edge_dt_btn_left_in;
    logic M_edge_dt_btn_left_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1840707699),
        .FALL(_MP_FALL_1840707699)
    ) edge_dt_btn_left (
        .clk(clk),
    ...
    localparam _MP_RISE_1152489179 = 1'h1;
    localparam _MP_FALL_1152489179 = 1'h0;
    logic M_edge_dt_btn_right_in;
    logic M_edge_dt_btn_right_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1152489179),
        .FALL(_MP_FALL_1152489179)
    ) edge_dt_btn_right (
        .clk(clk),
    ...
    localparam _MP_RISE_830698815 = 1'h1;
    localparam _MP_FALL_830698815 = 1'h0;
    logic M_edge_dt_btn_redshoot_in;
    logic M_edge_dt_btn_redshoot_out;
    
    edge_detector #(
        .RISE(_MP_RISE_830698815),
        .FALL(_MP_FALL_830698815)
    ...
    localparam _MP_RISE_1645519398 = 1'h1;
    localparam _MP_FALL_1645519398 = 1'h0;
    logic M_edge_dt_btn_greenshoot_in;
    logic M_edge_dt_btn_greenshoot_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1645519398),
        .FALL(_MP_FALL_1645519398)
    ...
    localparam _MP_RISE_936751049 = 1'h1;
    localparam _MP_FALL_936751049 = 1'h0;
    logic M_edge_dt_btn_start_btn_in;
    logic M_edge_dt_btn_start_btn_out;
    
    edge_detector #(
        .RISE(_MP_RISE_936751049),
        .FALL(_MP_FALL_936751049)
    ...
    localparam _MP_CLK_FREQ_913008672 = 24'h989680;
    localparam _MP_MIN_DELAY_913008672 = 5'h14;
    localparam _MP_NUM_SYNC_913008672 = 2'h2;
    logic M_btn_cond_left_in;
    logic M_btn_cond_left_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_913008672),
        .MIN_DELAY(_MP_MIN_DELAY_913008672),
        .NUM_SYNC(_MP_NUM_SYNC_913008672)
    ) btn_cond_left (
        .clk(clk),
    ...
    localparam _MP_CLK_FREQ_2024786792 = 24'h989680;
    localparam _MP_MIN_DELAY_2024786792 = 5'h14;
    localparam _MP_NUM_SYNC_2024786792 = 2'h2;
    logic M_btn_cond_right_in;
    logic M_btn_cond_right_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_2024786792),
        .MIN_DELAY(_MP_MIN_DELAY_2024786792),
        .NUM_SYNC(_MP_NUM_SYNC_2024786792)
    ) btn_cond_right (
        .clk(clk),
    ...
    localparam _MP_CLK_FREQ_1703862098 = 24'h989680;
    localparam _MP_MIN_DELAY_1703862098 = 5'h14;
    localparam _MP_NUM_SYNC_1703862098 = 2'h2;
    logic M_btn_cond_redshoot_in;
    logic M_btn_cond_redshoot_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_1703862098),
        .MIN_DELAY(_MP_MIN_DELAY_1703862098),
        .NUM_SYNC(_MP_NUM_SYNC_1703862098)
    ) btn_cond_redshoot (
        .clk(clk),
    ...
    localparam _MP_CLK_FREQ_1113809896 = 24'h989680;
    localparam _MP_MIN_DELAY_1113809896 = 5'h14;
    localparam _MP_NUM_SYNC_1113809896 = 2'h2;
    logic M_btn_cond_greenshoot_in;
    logic M_btn_cond_greenshoot_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_1113809896),
        .MIN_DELAY(_MP_MIN_DELAY_1113809896),
        .NUM_SYNC(_MP_NUM_SYNC_1113809896)
    ) btn_cond_greenshoot (
        .clk(clk),
    ...
    localparam _MP_CLK_FREQ_845455787 = 24'h989680;
    localparam _MP_MIN_DELAY_845455787 = 5'h14;
    localparam _MP_NUM_SYNC_845455787 = 2'h2;
    logic M_btn_cond_start_btn_in;
    logic M_btn_cond_start_btn_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_845455787),
        .MIN_DELAY(_MP_MIN_DELAY_845455787),
        .NUM_SYNC(_MP_NUM_SYNC_845455787)
    ) btn_cond_start_btn (
        .clk(clk),
    ...
    localparam _MP_STAGES_882296836 = 3'h4;
    logic M_reset_cond_in;
    logic M_reset_cond_out;
    
    reset_conditioner #(
        .STAGES(_MP_STAGES_882296836)
    ) reset_cond (
        .clk(clk),
        .in(M_reset_cond_in),
    ...
    localparam _MP_COLUMN_DIMENSION_1124827062 = 16'h10;
    localparam _MP_ROW_DIMENSION_1124827062 = 16'h10;
    localparam _MP_PIXEL_COUNT_1124827062 = 16'h100;
    localparam _MP_BUFFER_SIZE_1124827062 = 11'h400;
    localparam _MP_BULLET_SLOW_CLK_DIV_1124827062 = 5'h16;
    ...
    game_data_path #(
        .COLUMN_DIMENSION(_MP_COLUMN_DIMENSION_1124827062),
        .ROW_DIMENSION(_MP_ROW_DIMENSION_1124827062),
        .PIXEL_COUNT(_MP_PIXEL_COUNT_1124827062),
        .BUFFER_SIZE(_MP_BUFFER_SIZE_1124827062),
        .BULLET_SLOW_CLK_DIV(_MP_BULLET_SLOW_CLK_DIV_1124827062)
    ) game_data_path (
        .clk(clk),
        .rst(rst),
