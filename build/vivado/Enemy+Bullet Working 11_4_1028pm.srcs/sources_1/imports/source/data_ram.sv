...
module data_ram #(
    ...
    logic D_update_enemy_A_flag_d, D_update_enemy_A_flag_q = 1'h0;
    logic D_update_enemy_B_flag_d, D_update_enemy_B_flag_q = 1'h0;
    logic D_update_enemy_C_flag_d, D_update_enemy_C_flag_q = 1'h0;
    ...
    localparam _MP_WIDTH_292059120 = $clog2(ENCODING_AMOUNT);
    localparam _MP_ENTRIES_292059120 = DEPTH;
    logic [((($clog2(_MP_ENTRIES_292059120)-1) - (0) + 1))-1:0] M_ram_waddr;
    logic [(((_MP_WIDTH_292059120-1) - (0) + 1))-1:0] M_ram_write_data;
    logic M_ram_write_enable;
    logic [((($clog2(_MP_ENTRIES_292059120)-1) - (0) + 1))-1:0] M_ram_raddr;
    logic [(((_MP_WIDTH_292059120-1) - (0) + 1))-1:0] M_ram_read_data;
    
    simple_dual_port_ram #(
        .WIDTH(_MP_WIDTH_292059120),
        .ENTRIES(_MP_ENTRIES_292059120)
    ) ram (
        .rclk(clk),
        .wclk(clk),
        .waddr(M_ram_waddr),
    ...
    always @* begin
        ...
        D_update_enemy_A_flag_d = D_update_enemy_A_flag_q;
        D_update_enemy_B_flag_d = D_update_enemy_B_flag_q;
        D_update_enemy_C_flag_d = D_update_enemy_C_flag_q;
        ...
        D_update_enemy_C_flag_d = D_update_enemy_C_flag_q;
        ready = D_fsm_q == 5'h1d;
        if (enemy_A_update) begin
            D_update_enemy_A_flag_d = 1'h1;
        end
        if (enemy_B_update) begin
            D_update_enemy_B_flag_d = 1'h1;
        end
        if (enemy_C_update) begin
            D_update_enemy_C_flag_d = 1'h1;
        end
        if (update) begin
        ...
        case (D_fsm_q)
            ...
            5'h1d: begin
                ...
                if (D_update_flag_q) begin
                    ...
                    if (D_update_enemy_A_flag_q) begin
                        D_update_enemy_A_flag_d = 1'h0;
                        D_enemy_A_writer_pointer_d = enemy_A_y * COLUMN_DIMENSION + enemy_A_x;
                        D_fsm_d = 5'hb;
                    end else begin
                        if (D_update_enemy_B_flag_q) begin
                            D_update_enemy_B_flag_d = 1'h0;
                            D_enemy_B_writer_pointer_d = enemy_B_y * COLUMN_DIMENSION + enemy_B_x;
                            D_fsm_d = 5'h11;
                        end else begin
                            if (D_update_enemy_C_flag_q) begin
                                D_update_enemy_C_flag_d = 1'h0;
    ...
    always @(posedge (clk)) begin
        if ((rst) == 1'b1) begin
            ...
            D_update_enemy_A_flag_q <= 1'h0;
            D_update_enemy_B_flag_q <= 1'h0;
            D_update_enemy_C_flag_q <= 1'h0;
            ...
            D_update_enemy_A_flag_q <= D_update_enemy_A_flag_d;
            D_update_enemy_B_flag_q <= D_update_enemy_B_flag_d;
            D_update_enemy_C_flag_q <= D_update_enemy_C_flag_d;
