...
module enemy_rom #(
    ...
    localparam logic [7:0][2:0][2:0] ENEMY_COLOR = {{{{3'h1, 3'h2, 3'h1}}, {{3'h2, 3'h1, 3'h2}}, {{3'h2, 3'h2, 3'h1}}, {{3'h1, 3'h2, 3'h1}}, {{3'h2, 3'h1, 3'h2}}, {{3'h1, 3'h2, 3'h1}}, {{3'h2, 3'h1, 3'h2}}, {{3'h2, 3'h2, 3'h1}}}};
    always @* begin
