...
module data_ram #(
    ...
    localparam _MP_WIDTH_1381885125 = $clog2(ENCODING_AMOUNT);
    localparam _MP_ENTRIES_1381885125 = DEPTH;
    logic [((($clog2(_MP_ENTRIES_1381885125)-1) - (0) + 1))-1:0] M_ram_waddr;
    logic [(((_MP_WIDTH_1381885125-1) - (0) + 1))-1:0] M_ram_write_data;
    logic M_ram_write_enable;
    logic [((($clog2(_MP_ENTRIES_1381885125)-1) - (0) + 1))-1:0] M_ram_raddr;
    logic [(((_MP_WIDTH_1381885125-1) - (0) + 1))-1:0] M_ram_read_data;
    
    simple_dual_port_ram #(
        .WIDTH(_MP_WIDTH_1381885125),
        .ENTRIES(_MP_ENTRIES_1381885125)
    ) ram (
        .rclk(clk),
        .wclk(clk),
        .waddr(M_ram_waddr),
    ...
    always @* begin
        ...
        case (D_fsm_q)
            ...
            5'hc: begin
                ...
                if (enemy_A_active) begin
                    M_ram_write_data = enemy_A_color + 3'h4;
                end else begin
                    M_ram_write_data = 3'h0;
                end
                D_fsm_d = 5'hd;
            end
            5'hd: begin
            ...
            5'h12: begin
                ...
                if (enemy_B_active) begin
                    M_ram_write_data = enemy_B_color + 3'h4;
                end else begin
                    M_ram_write_data = 3'h0;
                end
                D_fsm_d = 5'h13;
            ...
            5'h18: begin
                ...
                if (enemy_C_active) begin
                    M_ram_write_data = enemy_C_color + 3'h4;
                end else begin
                    M_ram_write_data = 3'h0;
                end
                D_fsm_d = 5'h19;
