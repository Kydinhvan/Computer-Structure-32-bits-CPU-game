...
module game_cu #(
    ...
    localparam _MP_RISE_739689471 = 1'h1;
    localparam _MP_FALL_739689471 = 1'h0;
    logic M_bullet_slow_clk_edge_in;
    logic M_bullet_slow_clk_edge_out;
    
    edge_detector #(
        .RISE(_MP_RISE_739689471),
        .FALL(_MP_FALL_739689471)
    ...
    localparam _MP_RISE_357806514 = 1'h1;
    localparam _MP_FALL_357806514 = 1'h0;
    logic M_slow_clk_edge_in;
    logic M_slow_clk_edge_out;
    
    edge_detector #(
        .RISE(_MP_RISE_357806514),
        .FALL(_MP_FALL_357806514)
    ) slow_clk_edge (
        .clk(clk),
